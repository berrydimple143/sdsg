<form @submit.prevent="submit" class="max-w-7xl mx-auto bg-green-600 px-4 py-3 shadow-2xl">
    ...
    <div class="pb-3">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your first name here ..." x-model="firstname" id="firstname" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required=""> 
            <span x-show="errors.firstname" class="text-red-500" x-text="errors.firstname"></span>
        </div>

        <div>
            <label for="lastname" @blur="drawText" class="text-white text-shadow-lg block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name <span class="text-red-500 text-md font-bold">*</span></label>
        ...
        <div>
            <label for="middlename"  @blur="drawText" class="text-white text-shadow-lg block mb-2 text-sm font-medium text-gray-900 dark:text-white">Middle Name</label>
        ...
        <div>
            <label for="nickname"  @blur="drawText" class="text-white text-shadow-lg block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nickname</label>
        ...
        <div>
            <label for="suffix"  @blur="drawText" class="text-white text-shadow-lg block mb-2 text-sm font-medium text-gray-900 dark:text-white">Suffix (Jr.,Sr.)</label>
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your zip code here ..." x-model="zipcode" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="date" @blur="getBday('own')" placeholder="Select your date of birth here ..." x-model="birthdate" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your birth place here ..." x-model="birthplace" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your age here ..." x-model="age" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your religion here ..." x-model="religion" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your nationality here ..." x-model="nationality" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your country here ..." x-model="country" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your height here ..." x-model="height" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your weight here ..." x-model="weight" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div class="grid sm:grid-cols-4 gap-6 mb-6">	
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your father's name here ..." x-model="father" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your mother's name here ..." x-model="mother" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your spouse's name here ..." x-model="spouse" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your position here ..." x-model="position" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your skills here ..." x-model="skill" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your organization here ..." x-model="organization" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div class="grid sm:grid-cols-3 gap-6 mb-6">
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your contact number here ..." x-model="contact" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your facebook name here ..." x-model="fb" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="email" @blur="drawText" placeholder="Type your email here ..." x-model="email" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your SSS number here ..." x-model="sss" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your philhealth here ..." x-model="philhealth" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your voter's ID here ..." x-model="voter" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your passport here ..." x-model="passport" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your professional ID here ..." x-model="profid" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your pag-ibig number here ..." x-model="pagibig" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your driver's license number here ..." x-model="license" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your senior citizen ID here ..." x-model="senior" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your chairman's name here ..." x-model="chairman" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your area here ..." x-model="area" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your MC number here ..." x-model="mcnumber" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div class="grid sm:grid-cols-3 gap-6 mb-6">
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your emergency contact name here ..." x-model="contactname" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your emergency contact number here ..." x-model="contactnumber" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div>
                ...
                <input type="text" @blur="drawText" placeholder="Type your emergency contact address here ..." x-model="contactaddress" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your first beneficiary here ..." x-model="benname1" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="date" @blur="getBday('ben1')" placeholder="Select date of birth here ..." x-model="benbirthdate1" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your first beneficiary's age here ..." x-model="benage1" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your relationship to this person here ..." x-model="benrelationship1" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your second beneficiary name here ..." x-model="benname2" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="date" @blur="getBday('ben2')" placeholder="Select date of birth here ..." x-model="benbirthdate2" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your second beneficiary's age here ..." x-model="benage2" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your relationship to this person here ..." x-model="benrelationship2" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your third beneficiary name here ..." x-model="benname3" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="date" @blur="getBday('ben3')" placeholder="Select date of birth here ..." x-model="benbirthdate3" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your second beneficiary's age here ..." x-model="benage3" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your relationship to this person here ..." x-model="benrelationship3" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div id="benname4" class="hidden">
            ...
            <input type="text" @blur="drawText" placeholder="Type your fourth beneficiary name here ..." x-model="benname4" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div id="benbirthdate4" class="hidden">
            ...
            <input type="date" @blur="getBday('ben4')" placeholder="Select date of birth here ..." x-model="benbirthdate4" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div id="benage4" class="hidden">
            ...
            <input type="text" @blur="drawText" placeholder="Type your fourth beneficiary's age here ..." x-model="benage4" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
        ...
        <div id="benrelationship4" class="hidden">
            ...
            <input type="text" @blur="drawText" placeholder="Type your relationship to this person here ..." x-model="benrelationship4" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
    ...
    <div class="grid sm:grid-cols-3 gap-6 mb-6">
        ...
        <div>
            ...
            <input type="text" @blur="drawText" placeholder="Type your qualification/course to avail here ..." x-model="courseToAvail" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            <span x-show="errors.courseToAvail" class="text-red-500" x-text="errors.courseToAvail"></span>
        </div>

        <div @click.prevent="showSignatureModal" class="flex w-full justify-between items-center">
