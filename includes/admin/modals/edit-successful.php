<div id="editSuccessfulModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
  ...
  <div class="bg-green-400 p-6 rounded-lg shadow-lg max-w-sm mx-auto">
    ...
    <div class="text-center">
      ...
      <h3 class="mt-4 text-lg leading-6 font-medium text-black">Updated successfully!</h3>
      <div class="mt-2">
