        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="submitPayment" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            <label for="receiver" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Received By:</label>
                            <input type="text" x-model="receiver" name="receiver" id="receiver" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Please enter your receiver here ...">
                            <span x-show="errors.receiver" class="text-red-500" x-text="errors.receiver"></span>
                        </div>
