<div id="paymentsTableModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">            
        <div class="w-[90%] max-h-[90vh] overflow-y-auto bg-white rounded-lg shadow dark:border md:mt-0 dark:bg-gray-800 dark:border-gray-700">                     
            <div class="p-2">
                        ...
                        <tbody>
                            ...
                            <template x-for="(pay, index) in payments" :key="pay.id">
                                <tr class="bg-brand border-b border-brand-light hover:bg-green-500">
                                    ...
                                    <th scope="row" x-text="pay.created_at" class="px-6 py-4 font-medium text-fg-brand-subtle whitespace-nowrap">                                
                                    </th>
                                    <th scope="row" x-text="pay.number" class="px-6 py-4 font-medium text-fg-brand-subtle whitespace-nowrap">                                
                                    </th>                                   
                                    <th scope="row" class="flex items-center space-x-2 px-6 py-4 font-medium text-fg-brand-subtle whitespace-nowrap">                                     
