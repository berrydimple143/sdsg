<div id="changeSuccessful" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
  
  <!-- Modal Content Container -->
  <div class="bg-green-400 p-6 rounded-lg shadow-lg max-w-sm mx-auto">
    
    <!-- Success Icon and Message -->
    <div class="text-center">
      <!-- Green Checkmark Icon (replace with an actual SVG icon) -->
      <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100">
        <svg fill="#000" class="h-6 w-6 text-green-600" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
      ...
      <h3 class="mt-4 text-lg leading-6 font-medium text-black">Status Changed Successfully!</h3>
      <div class="mt-2">
        <p class="text-md text-gray-700">Your changes have been saved successfully.</p>
      </div>
    </div>   
  </div>
</div>