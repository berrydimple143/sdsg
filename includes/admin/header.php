<div x-data="home()" class="flex items-center justify-between text-white h-16 bg-gradient-to-t from-green-500 to-green-400 border-b border-green-700">
    ...
    <div class="pr-4">
                <div title="Logout" @click.prevent="logout" class="flex items-center justify-center text-white text-shadow-black px-3 py-2 bg-gradient-to-t from-green-600 to-green-500 border border-green-600 cursor-pointer hover:bg-green-800">
