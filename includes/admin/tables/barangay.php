<table class="w-full text-sm text-left rtl:text-right text-fg-brand-subtle">
    ...
    <tbody>
        ...
        <tr x-show="barangays.length === 0" class="bg-brand border-b border-brand-light hover:bg-green-500">
        ...
        <template x-for="(ben, index) in barangays" :key="ben.id">
            ...
            <tr class="bg-brand border-b border-brand-light hover:bg-green-500">
                ...
                <th scope="row" 
                    ...
                    <button 
                    @mouseover="showInformation(ben.bname, ben.dname, ben.cname, ben.pname, ben.rname, true)"
                    @mouseleave="showInformation(ben.bname, ben.dname, ben.cname, ben.pname, ben.rname, false)" 
                    type="button" 
                    id="infoButton"  
                    x-text="ben.bname" 
