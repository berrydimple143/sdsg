<table class="w-full text-sm text-left rtl:text-right text-fg-brand-subtle">
    ...
    <tbody>
        ...
        <tr x-show="districts.length === 0" class="bg-brand border-b border-brand-light hover:bg-green-500">
            <td colspan="6" class="px-3 py-2 text-center text-md font-bold">No districts yet ...</td>
        </tr>
        
        <template x-for="ben in districts" :key="ben.id">
            ...
            <tr class="bg-brand border-b border-brand-light hover:bg-green-500">
                <th scope="row"                     
                    ...
                    <button 
                    @mouseover="showInformation(ben.cname, ben.pname, ben.rname, true)"
                    @mouseleave="showInformation(ben.cname, ben.pname, ben.rname, false)" 
                    type="button" 
                    id="infoButton"  
                    x-text="ben.dname" 
