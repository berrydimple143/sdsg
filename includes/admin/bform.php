<div id="beneficiaryModal" class="flex items-center justify-center min-h-screen overflow-x-hidden hidden">  		 
         ...
         <form @submit.prevent="saveBeneficiary" class="max-w-7xl mx-auto bg-green-600 px-4 py-3 shadow-2xl">
            <div class="pb-3">
                ...
                <div>
                    ...
                    <input type="text"  placeholder="Type your first name here ..." x-model="firstname" id="firstname" class="bg-white mt-1 block w-full h-2/3 outline-1 outline-gray-700 p-2 rounded-none border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required=""> 
                ...
                <div class="pb-3">					
                    <p class="text-center text-gray-900 text-lg text-shadow-md uppercase bg-gradient-to-t from-green-400 to-green-200 rounded-md py-2">Beneficiaries <button @click.prevent="addBen" class="ml-3 border-1 border-green-800 rounded-md px-2 py-1 cursor-pointer text-white text-shadow-lg bg-green-600 shadow-lg hover:bg-green-800">+ Add</button></p>																
                </div>
            ...
            <div class="grid sm:grid-cols-3 gap-6 mb-6">
                ...
                <div class="grid sm:grid-cols-5 gap-6 mb-6">
                    <div>
                        <button type="submit" title="Click to register" class="text-white text-shadow-lg bg-green-700 border-1 border-green-200 hover:bg-green-900 font-medium rounded-none text-lg w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer shadow-lg">Save
                        </button>
                        <button type="button" @click.prevent="cancelSave" title="Cancel" class="text-white text-shadow-lg bg-red-700 border-1 border-red-200 hover:bg-red-900 font-medium rounded-none text-lg w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer shadow-lg">Cancel
                        </button>
                    </div>
                </div>
            </div>
