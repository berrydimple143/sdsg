...
<body x-data="{}" x-init="checkAuth()" class="w-screen h-screen bg-[url(../images/greenbg.jpg)] bg-center bg-cover bg-no-repeat">
  		...
  		<div class="flex h-screen bg-transparent">
					...
					<!-- Sidebar -->
					<div class="hidden peer-checked:flex md:flex flex-col w-56 bg-transparent transition-all duration-300 ease-in-out">
						<div class="flex items-center justify-between h-16 bg-green-900 opacity-90 px-4 border-b border-green-700">
							<span class="text-white font-bold uppercase">VJStore Panel</span>
					...
					<!-- Main content -->
					<div class="flex flex-col flex-1 overflow-y-auto">
						<div class="flex items-center justify-between text-white h-16 bg-gradient-to-t from-green-500 to-green-400 border-b border-green-700">
							...
							<div class="pr-4">
										<div class="flex items-center justify-center text-white text-shadow-black px-3 py-2 bg-gradient-to-t from-green-600 to-green-500 border border-green-600 cursor-pointer hover:bg-green-800">
											<button
												title="Logout" class="flex items-center justify-center text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 cursor-pointer">									
