                                    ...
                                    <tbody>
                                        ...
                                        <template x-for="ben in cities" :key="ben.id">
                                            ...
                                            <tr class="bg-brand border-b border-brand-light hover:bg-green-500">
                                                <th scope="row" x-text="ben.cityname" class="px-6 py-4 font-medium text-fg-brand-subtle whitespace-nowrap">                                
                                                </th>
	...
	<script>
        function pageLoad() {
		  return {
            ...
            async getcities() {
                let response = await fetch('http://localhost/sdsg/api/admin/getcities.php', {
                                method: 'POST',
                                headers: {'Content-Type': 'application/json'}
                            });
