<nav class="flex-1 px-2 py-4 bg-green-800 opacity-80">
	<a href="#" class="flex items-center px-4 py-2 text-gray-100 hover:bg-green-700 group">
	...
	<!-- Favourites -->
	<a href="#" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-green-700 group">
		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
